        ...
        >
            ...
            <div class="uploader-file-info">
                ...
                <div class="uploader-file-name">
                    <i class="uploader-file-icon" :icon="fileCategory" :class="coverImg(fileCategory)"></i>
                    <div class="file-info">
                ...
                <div class="uploader-file-status" v-show=" status !== 'paused'">
                    <span v-show="status !== 'uploading' && status !== 'paused'" :class="statusTextImg(status)">{{statusText}}</span>
                    <span v-show="status === 'uploading'">
                        <span>正在上传 <i class="upload-prograss">{{progressStyle.progress}}</i></span>
