            ...
            >
              ...
              >
                ...
                <span class="el-upload-list__item-actions">
                  ...
                  >
                    <i class="iconfont iconqiehuanxingshiyi icon-hover"></i>
                  </span>
                  <span
          ...
          <template>
            ...
            >
              <button style="width: 100%;" @click="handlerAddPicture">
                ...
                <i class="avatar-text" style=" display: block; font-size: 12px;"
                  >添加图片</i
                >
              </button>
            </div>
    ...
    getEditorImg() {
      ...
      if (this.isReplace == "singular") {
        this.imgData[0] &&
          this.$set(
            this.newFileList,
            this.curRepalceIndex,
            this.imgData[0].fullOssUrl
          );
      } else {
        if (this.imgData) {
