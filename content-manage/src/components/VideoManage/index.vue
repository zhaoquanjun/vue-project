<template>
    <el-container id="content-manage">
        ...
        <el-main>
            <list-header v-if="$store.state.dashboard.isContentwrite"
                         :count-pic="countPic"
                         ...
                         @batchMove="batchMove"></list-header>
            <el-main>
                <List ref="tableList"
                      ...
                      @handleSelectionChange="handleSelectionChange"></List>
                <el-dialog width="0"
                           style="z-index:10"
                    ...
                    <right-pannel :style="{width:isInvitationlWidth+'px'}"
                        ...
                        <SelectTree v-if="isInvitationPanelShow"
                                    :categoryName="curImgInfo.categoryName"
                                    :categoryId="curImgInfo.categoryId"
                                    :tree-result="treeResult"
                                    @chooseNode="chooseNode"></SelectTree>
        ...
        <el-dialog title="上传" :visible.sync="dialogTableVisible" :modal-append-to-body="false">
            ...
            <chunk-upload :tree-result="treeResult"
