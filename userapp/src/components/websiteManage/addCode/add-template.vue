    ...
    <div class="add-template">
        <div class="template">
            ...
            <div class="footer">
                ...
                <button v-show="!step1" class="cl-button cl-button--primary_notbg" @click="closeAddTemplate">取消</button>
                <Debounce :time="1000" !isDebounce>
                    <button v-show="step1" class="cl-button cl-button--primary" @click="saveAddTemplate">保存</button>
                </Debounce>
                <Debounce :time="1000" !isDebounce>
                    <button v-show="step1" class="cl-button cl-button--primary_notbg" @click="goSave(1)">上一步</button>
                </Debounce>
            </div>
        </div>
    </div>
