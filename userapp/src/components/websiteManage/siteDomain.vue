    ...
    <el-container class="member-container">
        ...
        <el-main class="member-content page-scroll">
            ...
            <div style="padding: 24px 17px;">
                ...
                <DomainMenu ref="domainMenu"
                            @handleTabClick="handleTabClick"
                            @handleBtn="righPanelShow" />
                <el-main>
                    <DomainList v-if="showType"
                                ...
                                @pauseCdn="_pauseCdn"
                                @getCdnDomainList="_getCdnDomainList"></DomainList>
        ...
        <el-dialog width="0"
            ...
            <BindDomain v-if="showType"
                        :domain-amount="domainAmount"
                        @closeDialog="closeDialog"
                        @getCdnDomainList="_getCdnDomainList"
                        @resolveCdnByAliYunToken="_resolveCdnByAliYunToken"></BindDomain>
            <AddRedirectDomain v-else
