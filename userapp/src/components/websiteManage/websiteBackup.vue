                                ...
                                <template slot-scope="scope">
                                    ...
                                    >
                                        <span slot="reference">
                                            <div
                                                class="remark-desc"
                                                @mouseenter="descriptionEnter(scope.$index, scope.row)"
                                                @mouseleave="descriptionLeave(scope.$index)"
                                            >{{scope.row.description}}</div>
                                            <svg-icon
                                                icon-class="remark"
                                                v-show="scope.row.remarkShow"
                                            ></svg-icon>
                                        </span>
                                ...
                                <template slot-scope="scope">
                                    <div class="handle-btn-wrap">
                                        <el-tooltip content="还原备份包" placement="top">
                                            <button
                                                class="handle-btn backup-btn"
                                                @click="recovery( scope )"
                                            ></button>
                                        </el-tooltip>
                                        <el-tooltip content="下载备份包" placement="top">
                                            <button
                                                class="handle-btn download-btn"
                                                @click="downloadBackup( scope )"
                                            ></button>
                                        </el-tooltip>
                                        <el-tooltip
                                            content="删除备份包"
    ...
    methods: {
        ...
        async getBackupSite() {
            ...
            for (var i = 0; i < this.autoSite.length; i++) {
                ...
                this.autoSite[i].dataSize =
                    this.autoSite[i].dataSize.toFixed(5) + "M";
