 ...
 * 开发环境的URL
 */
let memberManageApi = "http://localhost:8100";// 'http://api.dashboard.newwezhan.cn';
...
if (process.env.NODE_ENV === 'development') {
    ...
    authorityUrl = "http://localhost:8000";//"http://api.identity.newwezhan.cn";
    redirectUrl = "http://localhost:8082/callback";// "http://dashboard.newwezhan.cn/callback";
