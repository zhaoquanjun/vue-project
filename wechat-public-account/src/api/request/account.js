...
export const isAuth = param => {
  return ajaxRequest.post(`${environment.wechataccountApi}/api/v1/Platform/SelectPlatformDetailAuth`);
}

export const wxAuth = () => {
  return ajaxRequest.post(`${environment.wechataccountApi}/api/v1/OAuth/getweixinauthurl`);
}
